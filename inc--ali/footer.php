<footer>
    <div class="main-footer" style="background:url(img--ali/footer-bg.jpg) no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <div class="ft-item-all contact-ft">
                        ...
                        <ul>
                            <li>
                                <h6>Phone</h6>
                                <p><a href="tel:+971509038904">+971 50 903 8904</a> - <a href="tel:+971565388444">+971 56 538 8444</a></p>
            ...
            <div class="row border-tp">
                <div class="col-lg-3">
                    <div class="ft-logo">
                        <a href="#!"><img src="img--ali/ft-logo.svg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ft-social">
                ...
                <div class="col-lg-3">
                    <div class="pay-method">
                        <img src="img--ali/pay-method.png" alt="">
                    </div>
                </div>
            </div>
        </div>
